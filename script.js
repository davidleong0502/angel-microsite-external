  ...
  'feature-vault': {
    ...
    sections: [
      ...
      { kicker: '02 — Uploading', heading: 'What and how to upload', blocks: [
        ...
        { figure: { src: 'assets/vault1new.png', caption: 'Drag and drop files or folders directly onto the Files surface.', wide: true } },
      ...
      { kicker: '03 — Structure', heading: 'Have some folder structure', blocks: [
        ...
        { figure: { src: 'assets/vault2new.png', caption: 'Drilling into a sub-folder — separating "Licensee" from "Licensor" precedents keeps context clean.', wide: true } },
